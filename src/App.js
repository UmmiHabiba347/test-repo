...
function App() {
  return (
    <>
      <div className='bg-[#b9babe] h-screen relative'>
     ...
     <div className='fixed absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 mt-40  z-10'>
            <div className='mt-[10%] flex flex-row gap-[30px] justify-center'>
                 <Button className='w-[150px] text-[#333] rounded-[4px] bg-[#fff] p-2 w-[250px]  ' color='white' variant="filled">Order Now</Button>
                 <Button className='w-[150px] text-[#333] rounded-[4px] bg-[#333333] text-white p-2 w-[250px]' color='#333333'  variant="filled">Demo</Button>
            </div>
      </div>
          </div>
        </div>
